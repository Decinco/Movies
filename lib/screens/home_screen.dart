...
import 'package:movies/widgets/popular_actor.dart';
              ...
              (() => controller.isLoading.value
                  ...
                  : SizedBox(
                      ...
                      child: ListView.separated(
                        itemCount: actorsController.popularActors.length,
                        shrinkWrap: true,
                        scrollDirection: Axis.horizontal,
                        separatorBuilder: (_, __) => const SizedBox(width: 24),
                        itemBuilder: (_, index) => PopularActor(
                            actor: actorsController.popularActors[index],
                            index: index + 1),
                      ),
                    )),
            ),
